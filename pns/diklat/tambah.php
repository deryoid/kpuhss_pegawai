                                ...
                                <div class="card card-red">
                                    ...
                                    <div class="card-body" style="background-color: white;">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" name="status_diklat" value="Pengajuan" readonly>
                                            </div>
                                        </div>
                                    ...
                                    <div class="card-footer" style="background-color: white;">
                                        <a href="<?= base_url('pns/diklat/') ?>" class="btn bg-gradient-secondary float-right"><i class="fa fa-arrow-left"> Batal</i></a>
