        ...
        <div class="col-md-12">
            ...
            <form class="form-horizontal" method="post" action="">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-3">
                        <input type="text" class="form-control" name="username" value="<?= $datau['username'] ?>">
                        </div>
                    </div>
...
<?php 
    ...
    $submit = $koneksi->query("UPDATE user SET username = '$username', password = '$password' WHERE id_user = '$data[id_user]'");
