...
<body class="hold-transition sidebar-mini layout-fixed">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="card card-red">
                                    <div class="card-header">
                                        <h3 class="card-title">Rekap Nominatif PPNPN</h3>
                                    </div>
                                    <!-- /.card-header -->
                                    <!-- form start -->
                                    <div class="card-body" style="background-color: white;">
                                        ...
                                        <div class="form-group row">
                                            <label class="col-sm-2 col-form-label">Jumlah PPNPN</label>
                                            <div class="col-sm-10">
                                                <input type="number" class="form-control" name="jumlah_ppnpn" required="">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="number" class="form-control" name="pramubakti" required="">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-sm-2 col-form-label">Pengamanan</label>
                                            <div class="col-sm-10">
                                                <input type="number" class="form-control" name="pengamanan" required="">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-sm-2 col-form-label">Supir</label>
                                            <div class="col-sm-10">
                                                <input type="number" class="form-control" name="supir" required="">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-sm-2 col-form-label">Bidang Administrasi/Teknis</label>
                                            <div class="col-sm-10">
                                                <input type="number" class="form-control" name="bidang_administrasi" required="">
                                            </div>
                                        </div>
                                        <div class="form-group row">
    ...
    if (isset($_POST['submit'])) {
        ...
        $submit = $koneksi->query("INSERT INTO rekap_ppnpn VALUES (
        NULL,
        '$satker',
        '$jumlah_ppnpn',
        '$jk_lakilaki',
