...
$id = $_GET['id'];
$data = $koneksi->query("SELECT * FROM rekap_pns WHERE id_rekap_pns = '$id'");
...
<body class="hold-transition sidebar-mini layout-fixed">
                                ...
                                <div class="card card-red">
                                    ...
                                    <div class="card-body" style="background-color: white;">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="number" class="form-control" name="sekretaris" value="<?= $row['sekretaris'] ?>">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-sm-2 col-form-label">Kasubbag</label>
                                            <div class="col-sm-10">
                                                <input type="number" class="form-control" name="kasubbag" value="<?= $row['kasubbag'] ?>">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-sm-2 col-form-label">Jumlah Staff</label>
                                            <div class="col-sm-10">
                                                <input type="number" class="form-control" name="jumlah_staff" value="<?= $row['jumlah_staff'] ?>">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-sm-2 col-form-label">Jumlah Pegawai</label>
                                            <div class="col-sm-10">
                                                <input type="number" class="form-control" name="jumlah_pegawai" value="<?= $row['jumlah_pegawai'] ?>">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="number" class="form-control" name="jumlah_dpk" value="<?= $row['jumlah_dpk'] ?>">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-sm-2 col-form-label">Jumlah Organik</label>
                                            <div class="col-sm-10">
                                                <input type="number" class="form-control" name="jumlah_organik" value="<?= $row['jumlah_organik'] ?>">
                                            </div>
                                        </div>
                                        <div class="form-group row">
    ...
    if (isset($_POST['submit'])) {
        ...
        $submit = $koneksi->query("UPDATE rekap_pns SET 
        satker = '$satker',
        ...
        jumlah_dpk = '$jumlah_dpk',
        jumlah_organik = '$jumlah_organik',
        sd = '$sd',
        smp = '$smp',
        sma = '$sma',
        d1 = '$d1',
        ...
        es3 = '$es3',
        es4 = '$es4',
        ket_jabatan_kosong = '$ket_jabatan_kosong'
        WHERE 
        id_rekap_pns = '$id'
        ");
